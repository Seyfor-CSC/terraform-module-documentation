...
## Provider & Terraform Upgrade
- Azurerm provider: 4.45.0 (#55)
- Terraform: 1.13.3 (#55)
   
## Release v2.4.0

## Provider & Terraform Upgrade
- Azurerm provider: 4.33.0 (#53)
- Terraform: 1.12.2 (#53)
...
- Add tags `Platform` and `MonitoringTier` to `ignore_changes` (#51)
...
- Support for `storage_account_id` in diagnostic settings (#45)
