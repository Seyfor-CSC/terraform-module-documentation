...
variable "config" {  type = list(object({
    ...
    use_capacity_reservation                               = optional(bool, false) # Custom parameter used for filtering in the capacity-reservation module
...
|use_capacity_reservation | bool | Optional |  false |  Custom parameter used for filtering in the capacity-reservation module |
